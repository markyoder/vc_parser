...
def psa_forecast_1(ary_in=None, m0=7.0, b_0 = 0.0, nyquist_factor=.5, do_plot=False, fnum=0, set_name=None, f_gt_lt=operator.lt, section_id=16, detail=False):
	...
	# (the rest of the original code is deleted but recoverable in Git.
	# see commit: commit 1d4dfa2f13d5d1a0242f46357e7e14294df6def8 on 14 july 2015.
...
def psa_forecast_1b(ary_in=None, m0=7.0, b_0 = 0.0, b_1=None, nyquist_factor=.5, do_plot=False, fnum=0, set_name=None, f_gt_lt=operator.lt, section_id=16, detail=False):
	...
	return alert_segments
#
#### rate forecast stuff (experimented with, but i think not conclusive or not interesting...):
